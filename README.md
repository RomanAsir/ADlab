...
## Pruebas realizadas
Durante el laboratorio se verificó el correcto funcionamiento de:
...
Es un proyecto especialmente útil como evidencia práctica para un portfolio profesional orientado a entornos de sistemas y soporte técnico.
